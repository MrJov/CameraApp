package net.sourceforge.jov_opencamera;
...
import net.sourceforge.jov_opencamera.UI.MainUI;
import net.sourceforge.jov_opencamera.UI.ManualSeekbars;
...
public class MainActivity extends Activity {
	...
	static private final String ACTION_SHORTCUT_CAMERA = "net.sourceforge.jov_opencamera.SHORTCUT_CAMERA";
	static private final String ACTION_SHORTCUT_SELFIE = "net.sourceforge.jov_opencamera.SHORTCUT_SELFIE";
	static private final String ACTION_SHORTCUT_VIDEO = "net.sourceforge.jov_opencamera.SHORTCUT_VIDEO";
	static private final String ACTION_SHORTCUT_GALLERY = "net.sourceforge.jov_opencamera.SHORTCUT_GALLERY";
	static private final String ACTION_SHORTCUT_SETTINGS = "net.sourceforge.jov_opencamera.SHORTCUT_SETTINGS";
	...
	void launchOnlineHelp(String append) {
		...
		Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://jov_opencamera.sourceforge.io/"+ append));
		startActivity(browserIntent);
	}
