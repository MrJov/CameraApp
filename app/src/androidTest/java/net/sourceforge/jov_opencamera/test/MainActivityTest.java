package net.sourceforge.jov_opencamera.test;
...
import net.sourceforge.jov_opencamera.CameraController.CameraController2;
import net.sourceforge.jov_opencamera.HDRProcessor;
import net.sourceforge.jov_opencamera.HDRProcessorException;
import net.sourceforge.jov_opencamera.MainActivity;
import net.sourceforge.jov_opencamera.MyApplicationInterface;
import net.sourceforge.jov_opencamera.PreferenceKeys;
import net.sourceforge.jov_opencamera.Preview.VideoProfile;
import net.sourceforge.jov_opencamera.SaveLocationHistory;
import net.sourceforge.jov_opencamera.CameraController.CameraController;
import net.sourceforge.jov_opencamera.Preview.Preview;
import net.sourceforge.jov_opencamera.UI.FolderChooserDialog;
import net.sourceforge.jov_opencamera.UI.PopupView;
...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public MainActivityTest() {
		super("net.sourceforge.jov_opencamera", MainActivity.class);
	}
	...
	private void switchToFlashValue(String required_flash_value) {
		if( mPreview.supportsFlash() ) {
			...
			if( !flash_value.equals(required_flash_value) ) {
			    ...
			    View popupButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.popup);
	...
	private void switchToISO(int required_iso) {
		...
		if( iso != required_iso ) {
			...
			View exposureButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure);
			View exposureContainer = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_container);
	...
	private void setToDefault() {
		...
		if( mPreview.isVideo() ) {
		    ...
		    View switchVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.switch_video);
		...
		if( mPreview.getCameraControllerManager().getNumberOfCameras() > 1 ) {
			...
			while( cameraId != 0 ) {
			    View switchCameraButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.switch_camera);
	...
	private void subTestSaveVideoMode() {
		...
		View takePhotoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.take_photo);
	    View switchVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.switch_video);

	    assertTrue(!mPreview.isVideo());
		assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.take_photo) ) );
		assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.switch_to_video) ) );

	    clickView(switchVideoButton);
		waitUntilCameraOpened();
	    assertTrue(mPreview.isVideo());
		assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.start_video) ) );
		assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.switch_to_photo) ) );
	...
	private void subTestExposureLockNotSaved() {
	    ...
	    View exposureLockButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_lock);
	...
	public void testFlashVideoMode() throws InterruptedException {
		...
		restart();
	    switchVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.switch_video);
	    assertTrue(mPreview.isVideo());
		assertTrue(mPreview.getCurrentFlashValue().equals("flash_off"));
	...
	public void testFlashStartup() throws InterruptedException {
	    ...
	    //View flashButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.flash);
	    //clickView(flashButton);
		switchToFlashValue("flash_torch");
	...
	public void testAutoFocus() throws InterruptedException {
		...
		for(String supported_focus_value : supported_focus_values) {
		    ...
		    //View focusModeButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.focus_mode);
	...
	public void testTakePhotoExposureCompensation() throws InterruptedException {
	    ...
	    View exposureButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure);
		View exposureContainer = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_container);
		SeekBar seekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_seekbar);
	...
	public void testTakePhotoManualISOExposure() throws InterruptedException {
		...
		View exposureButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure);
		View exposureContainer = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.manual_exposure_container);
		SeekBar isoSeekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.iso_seekbar);
	    SeekBar exposureTimeSeekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_time_seekbar);
	    assertTrue(exposureButton.getVisibility() == View.VISIBLE);
	    assertTrue(exposureContainer.getVisibility() == View.GONE);
	...
	public void testTakePhotoManualWB() throws InterruptedException {
		...
		SeekBar white_balance_seek_bar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.white_balance_seekbar);
		...
		ScrollView popupContainer = (ScrollView)mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.popup_container);
		...
		*/
		...
		View exposureContainer = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_container);
		SeekBar seekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_seekbar);
        View manualWBContainer = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.manual_white_balance_container);
		SeekBar seekBarWB = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.white_balance_seekbar);
	...
	public void testAudioControlIcon() {
	    ...
	    View audioControlButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.audio_control);
	    ...
	    audioControlButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.audio_control);
	...
	private void waitForTakePhoto() {
		...
		View switchVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.switch_video);
		//View flashButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.flash);
		//View focusButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.focus_mode);
		View exposureButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure);
		View exposureLockButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.exposure_lock);
		View audioControlButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.audio_control);
		View popupButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.popup);
		View trashButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.trash);
		View shareButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.share);
	...
	public void testTakePhotoFrontCamera() throws InterruptedException {
		...
		assertTrue(cameraId != new_cameraId);
		assertTrue( contentDescription.equals( mActivity.getResources().getString(new_is_front_facing ? net.sourceforge.jov_opencamera.R.string.switch_to_front_camera : net.sourceforge.jov_opencamera.R.string.switch_to_back_camera) ) );
		assertTrue( new_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? net.sourceforge.jov_opencamera.R.string.switch_to_front_camera : net.sourceforge.jov_opencamera.R.string.switch_to_back_camera) ) );
		subTestTakePhoto(false, false, true, true, false, false, false, false);
		...
		assertTrue( restart_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? net.sourceforge.jov_opencamera.R.string.switch_to_front_camera : net.sourceforge.jov_opencamera.R.string.switch_to_back_camera) ) );
	...
	public void testTakePhotoManualFocus() throws InterruptedException {
	    ...
	    SeekBar seekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.focus_seekbar);
	...
	public void testImmersiveMode() throws InterruptedException {
	    ...
	    View trashButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.trash);
	    View shareButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.share);
	    View zoomSeekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.zoom_seekbar);
		View takePhotoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.take_photo);
		View pauseVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.pause_video);
		View takePhotoVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.take_photo_when_video_recording);
	    assertTrue(switchCameraButton.getVisibility() == View.VISIBLE);
	    assertTrue(switchVideoButton.getVisibility() == View.VISIBLE);
	    int exposureVisibility = exposureButton.getVisibility();
	    int exposureLockVisibility = exposureLockButton.getVisibility();
	...
	private int subTestTakeVideo(boolean test_exposure_lock, boolean test_focus_area, boolean allow_failure, boolean immersive_mode, VideoTestCallback test_cb, long time_ms, boolean max_filesize, boolean subtitles) throws InterruptedException {
	    ...
	    View switchVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.switch_video);
		if( mPreview.isVideo() ) {
			assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_video_selector );
			assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_photo );
			assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.start_video) ) );
			assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.pause_video) ) );
			assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.switch_to_photo) ) );
		}
		else {
			assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_photo_selector );
			assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_video );
			assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.take_photo) ) );
			assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.pause_video) ) );
			assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.switch_to_video) ) );
		}
	    ...
	    if( mPreview.isVideoRecording() ) {
		    assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_video_recording );
            assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_photo );
			assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.stop_video) ) );
			assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.pause_video) ) );
	    ...
	    assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_video_selector );
        assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.jov_opencamera.R.drawable.take_photo );
		assertEquals( takePhotoButton.getContentDescription(), mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.start_video) );
		assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.pause_video) ) );
	...
	public void testTakeVideoPause() throws InterruptedException {
		...
		final View pauseVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.pause_video);
		assertTrue( pauseVideoButton.getVisibility() == View.GONE );
		...
		subTestTakeVideo(false, false, false, false, new VideoTestCallback() {
			...
			public int doTest() {
				...
				assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.jov_opencamera.R.string.resume_video) ) );
				assertTrue( pauseVideoButton.getVisibility() == View.VISIBLE );
				assertTrue( mPreview.isVideoRecording() );
				assertTrue( mPreview.isVideoRecordingPaused() );
	...
	private void subTestTakeVideoSnapshot() throws InterruptedException {
		...
		final View takePhotoVideoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.take_photo_when_video_recording);
		assertTrue( takePhotoVideoButton.getVisibility() == View.GONE );
	...
	public void testTakeVideoSettings() throws InterruptedException {
		...
		// now go to settings
	    View settingsButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.settings);
	...
	private void subTestTimer(int type) {
		...
		try {
			...
			takePhotoButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.take_photo);
	...
	public void testPopupLayout() throws InterruptedException {
	    ...
	    for(int i=0;i<50;i++) {
            View popup_container = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.popup_container);
            View popupButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.popup);
            final float scale = mActivity.getResources().getDisplayMetrics().density;
	...
	public void testZoom() {
	    ...
	    final ZoomControls zoomControls = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.zoom);
		assertTrue(zoomControls.getVisibility() == View.GONE);

	    final SeekBar zoomSeekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.zoom_seekbar);
		assertTrue(zoomSeekBar.getVisibility() == View.VISIBLE);
	...
	public void testGallery() {
	    ...
	    View galleryButton = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.gallery);
	...
	public void testTakePhotoFocusBracketing() throws InterruptedException {
	    ...
	    SeekBar focusSeekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.focus_seekbar);
	    assertTrue(focusSeekBar.getVisibility() == View.GONE);
	    SeekBar focusTargetSeekBar = mActivity.findViewById(net.sourceforge.jov_opencamera.R.id.focus_bracketing_target_seekbar);
